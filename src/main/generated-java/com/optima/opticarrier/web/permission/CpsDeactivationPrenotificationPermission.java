...
@Named
@Singleton
public class CpsDeactivationPrenotificationPermission extends GenericPermission<CpsDeactivationPrenotification> {
    public CpsDeactivationPrenotificationPermission() {
