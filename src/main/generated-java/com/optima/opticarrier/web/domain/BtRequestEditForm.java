...
/**
 * View Helper/Controller to edit {@link BtRequest}.
 */
@Named
@ConversationContextScoped
public class BtRequestEditForm extends GenericEditForm<BtRequest, Integer> {
    @Inject
    protected BtRequestController btRequestController;

    @Inject
    public BtRequestEditForm(BtRequestRepository btRequestRepository) {
        super(btRequestRepository);
    }
    ...
    public String print() {
        return btRequestController.print(getBtRequest());
    }
}
