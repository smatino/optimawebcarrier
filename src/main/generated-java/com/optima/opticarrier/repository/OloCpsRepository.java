...
/**
 * {@link GenericRepository} for {@link OloCps} 
 */
@Named
@Singleton
public class OloCpsRepository extends GenericRepository<OloCps, Integer> {

    public OloCpsRepository() {
        super(OloCps.class);
    }

    @Override
    public OloCps getNew() {
        return new OloCps();
    }

    @Override
    public OloCps getNewWithDefaults() {
